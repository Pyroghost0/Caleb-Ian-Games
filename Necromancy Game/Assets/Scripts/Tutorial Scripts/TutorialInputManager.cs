...
public class TutorialInputManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(inputManager.leftButton) && !Input.GetKey(inputManager.middleButton) && !Input.GetKey(inputManager.rightButton) && allowLeft)
        {
            if (!inputManager.buttonPressed)
            {
            ...
            else if (buttonType == ButtonPressed.left && allowDouble)
            {
            ...
            else if (buttonType == ButtonPressed.middle && allowMiddle)
            {
            ...
            else if (buttonType == ButtonPressed.right && allowRight)
            {
        ...
        else if (Input.GetKeyDown(inputManager.middleButton) && !Input.GetKey(inputManager.leftButton) && !Input.GetKey(inputManager.rightButton) && allowMiddle)
        {
            if (!inputManager.buttonPressed)
            {
                if (allowHoldMovement)
            ...
            else if (buttonType == ButtonPressed.middle && allowDouble)
            {
            ...
            else if (buttonType == ButtonPressed.left && allowLeft)
            {
        ...
        else if (Input.GetKeyDown(inputManager.rightButton) && !Input.GetKey(inputManager.leftButton) && !Input.GetKey(inputManager.middleButton) && allowRight)
        {
            if (!inputManager.buttonPressed)
            {
                if (allowHoldMovement)
            ...
            else if (buttonType == ButtonPressed.right && allowDouble)
            {
        ...
        else if (buttonPressTimer >= buttonPressTime)
        {
            ...
            {
                if (Input.GetKey(inputManager.leftButton) && allowHold)
                {
                    //Debug.Log("Hold Left");
                    HoldPress(buttonType);
                }
                else if (buttonType == ButtonPressed.left && allowSingle)
                {
                    //Debug.Log("Single Left");
                    SinglePress(buttonType);
                }
                else if (Input.GetKey(inputManager.middleButton) && allowHold)
                {
                    //Debug.Log("Hold Middle");
                    HoldPress(buttonType);
                }
                else if (buttonType == ButtonPressed.middle && allowSingle)
                {
                    //Debug.Log("Single Middle");
                    SinglePress(buttonType);
                }
                else if (Input.GetKey(inputManager.rightButton) && allowHold)
                {
                    //Debug.Log("Hold Right");
                    HoldPress(buttonType);
                }
                else if (buttonType == ButtonPressed.right && allowSingle)
                {
                    //Debug.Log("Single Right");
                    SinglePress(buttonType);
                }
